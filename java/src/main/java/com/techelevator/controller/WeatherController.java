...
public class WeatherController {
    ...
    @GetMapping("/weather") // http://localhost:9000/weather?zip=XXXX => zip will be request param
    public WeatherDto getWeather(@RequestParam String zip, Principal principal){
